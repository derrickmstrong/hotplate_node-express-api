...
<!-- [![Product Name Screen Shot][product-screenshot]](https://example.com) -->
 ...
 <!-- `derrickmstrong`, `hotplate_node-express-api`, `dmstr0ng`, `derrickmstrong`, `derrickmstrong`, `hotplate_node-express-api`, `This is a custom boilerplate that I created to quickly spin up a Node/Express project. ` -->
...
See the [open issues](https://github.com/derrickmstrong/hotplate_node-express-api/issues) for a full list of proposed features (and known issues).
